    ...
    <style>
        ...
        * {
        ...
        .overlay-category {
            ...
            background: linear-gradient(0deg, rgb(0, 0, 0) 0%, rgb(4, 4, 4) 2%,rgb(8, 8, 8) 5%, rgba(255, 255, 255, 0) 51%);;
        ...
        <div class="row justify-content-center">
            @foreach($categories as $category)
                <div class="col-xl-6 col-md-8 col-sm-14 col-xs-18">
                    <a href="{{route('get.sub_categories',$category->id)}}" class="category-image">
                        <div class="category-card" style="overflow: hidden; position: relative">
                            ...
                            <div class="category-details mt-1">
                                <h3 class="category-name mb-1" style="">{{$category->name}}</h3>
