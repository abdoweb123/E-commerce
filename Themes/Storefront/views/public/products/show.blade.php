...
@push('scripts')
    ...
    <script>
        ...
        function changeBackgroundColor(clickedElement,name) {

            // Get all elements with class 'form-label' that are siblings of the input with the given name
            var labels = document.querySelectorAll('input[name="options[' + name +']"] ~ .form-label');

            console.log($(''));

            // Change the background color of each found label
            ...
            var my_div = $(clickedElement).find('.form-label');

            if (my_div.length > 0) {
                my_div.css({
                    borderColor: 'rgb(0 0 0 / 62%)',
                    backgroundColor: '#e9e9e969',
                });
            }

            // $(this).children('.form-label').css({
            //     borderColor:'#504d4d9e'
            // });

        }


        // $('.form-radio-prices').click(function (name){
        //     console.log(name);
        // });
...
<div class="form-radio form-radio-prices" onclick="changeBackgroundColor('1')">
    <input name="1">
    <div class="form-label">
        <label class="label-description" for="option-1-value-1">
            erewrwre
        </label>
    </div>
</div>
...
<div class="form-radio form-radio-prices" onclick="changeBackgroundColor('2')">
    <input name="2">
    <div class="form-label">
        <label class="label-description" for="option-2-value-2">
            erewrwre
        </label>
    </div>
</div>
...
<script>
    function changeBackgroundColor(name) {
        ...
        // Get all elements with class 'form-label' that are siblings of the input with the given name
        var labels = document.querySelectorAll('input[name="' + name + '"] ~ .form-label');
